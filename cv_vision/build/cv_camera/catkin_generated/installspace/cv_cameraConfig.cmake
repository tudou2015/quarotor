...
if("FALSE" STREQUAL "TRUE")
  set(cv_camera_SOURCE_PREFIX /home/odroid/cv_vision/src/cv_camera)
  set(cv_camera_DEVEL_PREFIX /home/odroid/cv_vision/devel)
  ...
  set(cv_camera_INSTALL_PREFIX /home/odroid/cv_vision/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/cv_vision/install/${idir}'.  Ask the maintainer 'Takashi Ogura <t.ogura@gmail.com>' to fix it.")
    endif()
