...
if("TRUE" STREQUAL "TRUE")
  set(robot_vision_SOURCE_PREFIX /home/odroid/cv_vision/src/robot_vision)
  set(robot_vision_DEVEL_PREFIX /home/odroid/cv_vision/devel)
  ...
  set(robot_vision_INSTALL_PREFIX /home/odroid/cv_vision/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'robot_vision' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'odroid <odroid@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'robot_vision' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/odroid/cv_vision/src/robot_vision/${idir}'.  Ask the maintainer 'odroid <odroid@todo.todo>' to fix it.")
    endif()
